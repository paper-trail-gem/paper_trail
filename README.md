...
```
*Note: starting with v4.0, versions are saved with an after_callback instead of before_callback. Hence if you want to decide whether to save a new version based on changed attributes, you must use attribute_name**_was** instead of attribute_name.*
