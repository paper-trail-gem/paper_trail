...
ActiveRecord::Schema.define(version: 20110208155312) do
  ...
  create_table "banana_versions", force: :cascade do |t|
    ...
    t.index ["item_type", "item_id"], name: "index_banana_versions_on_item_type_and_item_id", using: :btree
  end
  ...
  create_table "bar_habtms_foo_habtms", id: false, force: :cascade do |t|
    ...
    t.index ["bar_habtm_id"], name: "index_bar_habtms_foo_habtms_on_bar_habtm_id", using: :btree
    t.index ["foo_habtm_id"], name: "index_bar_habtms_foo_habtms_on_foo_habtm_id", using: :btree
  end
  ...
  create_table "custom_primary_key_record_versions", force: :cascade do |t|
    ...
    t.text     "object"
    t.datetime "created_at"
    t.index ["item_type", "item_id"], name: "idx_cust_pk_item", using: :btree
  end
  ...
  create_table "json_versions", force: :cascade do |t|
    t.string   "item_type",      null: false
    t.integer  "item_id",        null: false
    t.string   "event",          null: false
    t.string   "whodunnit"
    ...
    t.datetime "created_at"
    t.index ["item_type", "item_id"], name: "index_json_versions_on_item_type_and_item_id", using: :btree
  end
  ...
  create_table "post_versions", force: :cascade do |t|
    ...
    t.string   "ip"
    t.string   "user_agent"
    t.index ["item_type", "item_id"], name: "index_post_versions_on_item_type_and_item_id", using: :btree
  end
